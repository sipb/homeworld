...
const SignKubernetesSupervisorAPI = "grant-kubernetes-supervisor"
const SignKubernetesCtrlMgrAPI = "grant-kubernetes-ctrl-mgr"
const SignKubernetesProxyAPI = "grant-kubernetes-proxy"
const SignKubernetesSchedulerAPI = "grant-kubernetes-scheduler"
