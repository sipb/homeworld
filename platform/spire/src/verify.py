...
@command.wrap
def check_metallb():
    "verify that metallb is running"
    expect_prometheus_query_exact('sum(up{job="metallb-controller"})', 1, "metallb controller is online")
    expect_prometheus_query_exact('sum(up{job="metallb-speaker"})', 1, "metallb speaker is online")
    print("metallb is running")
