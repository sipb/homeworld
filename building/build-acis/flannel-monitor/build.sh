...
tar -C "${BUILDDIR}" -xf "${UPSTREAM}/kubernetes-src-v1.9.2.tar.xz" staging/src/k8s.io/ vendor/github.com/ vendor/golang.org/ vendor/gopkg.in/ vendor/k8s.io/kube-openapi/pkg/common
